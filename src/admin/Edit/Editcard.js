...
export default function Editcard({ className }) {
                    ...
                    <div class="col-12 d-flex justify-content-center">
                        ...
                        <div className="col-8">
                            <div class="m-4 d-flex justify-content-end">
                                <input type="text" class="  form-control q-text container-fluid" placeholder='ชื่อ-การ์ดแต่งงาน' id='title' required></input>
                            </div>
                            <div class="form-outline m-4 d-flex justify-content-end">
                                <textarea class="form-control" id="textAreaExample" rows="4" placeholder='รายละเอียด-การ์ดแต่งงาน'></textarea>
                            </div>

                            <div class="m-4 d-flex justify-content-end">
                                <input type="text" class="  form-control q-text container-fluid " placeholder='ราคา-การ์ดแต่งงาน' id='title' required></input>
                            </div>
                            <div class="d-flex m-4 d-flex justify-content-end">
                            <a href="/my_wedding_planner"><button class="btnCancel border-0 rounded-2 text-light m-2 px-4 py-1 btn-lg">Cancel</button></a>
